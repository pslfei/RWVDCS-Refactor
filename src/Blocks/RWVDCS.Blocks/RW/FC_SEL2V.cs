...
{
	[FCName("SEL2V")]
	[FCDisplay("带限速的模拟量两值优选模块")]
	public partial class SEL2V : Function
	{
		...
		[PinType(PinTypes.Output)]
		[PinDisplay("HMI 状态打包点 (PACK)，按位映射 X1/X2 禁用/品质/DevH/QA/MODE/速率/非首次运算")]
		public LP32 TAG = new LP32();

		// ==================== 参数 ====================

		[PinType(PinTypes.Constant)]
		[PinDisplay("优选模式初始值  0=AVG平均  1=MIN低选  2=MAX高选")]
		...
		[PinType(PinTypes.Internal)]
		[PinDisplay("当前优选模式 (受 HMI CAG/CMN/CMX 切换)")]
