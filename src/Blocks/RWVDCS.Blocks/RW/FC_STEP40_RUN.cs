...
namespace RWVDCS.Blocks.RW
{
    public partial class STEP40
    {
        protected override void Run(ICommand cmd)
        {
            ...
            // ================== 7. 四 PACK 装配 → TAG/PK2/PK3/PK4.Value ==================

            // --- PACK1 (TAG) — FB1-8 / OUT1-8 / RUN/FAIL/END/START/PAUSE/SKIP/TRACK/RST/EN/paused ---
            uint pack1 = 0;
            if (FB1) pack1 |= (1u << 0);
            if (FB2) pack1 |= (1u << 1);
            if (FB3) pack1 |= (1u << 2);
            ...
            if (OUT33) pack4 |= (1u << 8);
            if (OUT34) pack4 |= (1u << 9);
            if (OUT35) pack4 |= (1u << 10);
            if (OUT36) pack4 |= (1u << 11);
            if (OUT37) pack4 |= (1u << 12);
            if (OUT38) pack4 |= (1u << 13);
            if (OUT39) pack4 |= (1u << 14);
            if (OUT40) pack4 |= (1u << 15);
        ...
        private int FindNextStep(int from, uint bitDis, int maxSteps)
        {
            ...
            {
                // BitDis 为 UDINT (32 位)，仅步序 1~32 可通过 BitDis 屏蔽；33~40 默认不屏蔽
                if (i <= 32)
                {
                    if (((bitDis >> (i - 1)) & 1u) == 0u) return i;
                }
                else
                {
                    return i;
        ...
        private float GetTIM(int step)
        {
            switch (step)
            {
                ...
                case 33: return TIM33;
                case 34: return TIM34;
                case 35: return TIM35;
                case 36: return TIM36;
                case 37: return TIM37;
                case 38: return TIM38;
                case 39: return TIM39;
                case 40: return TIM40;
        ...
        private float GetTLmt(int step)
        {
            switch (step)
            {
                ...
                case 33: return TLmt33;
                case 34: return TLmt34;
                case 35: return TLmt35;
                case 36: return TLmt36;
                case 37: return TLmt37;
                case 38: return TLmt38;
                case 39: return TLmt39;
                case 40: return TLmt40;
                default: return 60f;
            }
        }
        ...
        private void SetOutput(int step, bool value)
        {
            switch (step)
            {
                ...
                case 33: OUT33[0] = value; break;
                case 34: OUT34[0] = value; break;
                case 35: OUT35[0] = value; break;
                case 36: OUT36[0] = value; break;
                case 37: OUT37[0] = value; break;
                case 38: OUT38[0] = value; break;
                case 39: OUT39[0] = value; break;
                case 40: OUT40[0] = value; break;
            }
        }
        ...
        private void ClearAllOutputs()
        {
            ...
            OUT33[0] = false; OUT34[0] = false; OUT35[0] = false; OUT36[0] = false;
            OUT37[0] = false; OUT38[0] = false; OUT39[0] = false; OUT40[0] = false;
        }
    }
}
